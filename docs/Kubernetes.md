...
### Керування Додатками (Deployments)
...
### Додатки зі Станом (StatefulSets)
...
### Зовнішня Конфігурація (ConfigMaps)
...
### Ресурси Сховища (PersistentVolumes - PV)
...
### Запити на Сховище (PersistentVolumeClaims - PVC)
...
### Віртуальні Кластери (Namespaces)
